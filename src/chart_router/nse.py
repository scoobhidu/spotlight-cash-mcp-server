...
nseChartRouter = APIRouter()

@nseChartRouter.get('/nse_line_chart')
@nseChartRouter.post('/nse_line_chart')
async def get_nse_line_chart(request: Request, symbol: str, period: str):
    url = f"{DATA_API_HOST}/stocks/nse/v2/linechart?token={master[symbol]}&period={period}"
